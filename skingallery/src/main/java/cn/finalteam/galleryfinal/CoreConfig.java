...
public class CoreConfig {
    ...
    private static final String TAG = "CoreConfigDebug";
    ...
    private CoreConfig(Builder builder) {
        ...
        if (!takePhotoFolder.exists()) {
            boolean success = takePhotoFolder.mkdirs();
            Log.d(TAG, "CoreConfig:create takePhotoFolder result is " + success);
        }
        ...
        if (!editPhotoCacheFolder.exists()) {
            boolean success = editPhotoCacheFolder.mkdirs();
            Log.d(TAG, "CoreConfig:create editPhotoCacheFolder result is " + success);
        }
    }
